...
const (
	...
	TErrorCode_PARQUET_BIT_PACKED_LEVELS TErrorCode = 115
	TErrorCode_ROW_BATCH_TOO_LARGE TErrorCode = 116
	TErrorCode_LIB_VERSION_MISMATCH TErrorCode = 117
	TErrorCode_SCRATCH_READ_VERIFY_FAILED TErrorCode = 118
	TErrorCode_CANCELLED_INTERNALLY TErrorCode = 119
	TErrorCode_SERVER_SHUTTING_DOWN TErrorCode = 120
	TErrorCode_PARQUET_TIMESTAMP_INVALID_TIME_OF_DAY TErrorCode = 121
	TErrorCode_PARQUET_CORRUPT_BOOL_VALUE TErrorCode = 122
	TErrorCode_THREAD_POOL_SUBMIT_FAILED TErrorCode = 123
	TErrorCode_THREAD_POOL_TASK_TIMED_OUT TErrorCode = 124
	TErrorCode_UNREACHABLE_IMPALADS TErrorCode = 125
	TErrorCode_INACTIVE_SESSION_EXPIRED TErrorCode = 126
	TErrorCode_INACTIVE_QUERY_EXPIRED TErrorCode = 127
	TErrorCode_EXEC_TIME_LIMIT_EXCEEDED TErrorCode = 128
	TErrorCode_CPU_LIMIT_EXCEEDED TErrorCode = 129
	TErrorCode_SCAN_BYTES_LIMIT_EXCEEDED TErrorCode = 130
	TErrorCode_ROWS_PRODUCED_LIMIT_EXCEEDED TErrorCode = 131
	TErrorCode_EXPR_REWRITE_RESULT_LIMIT_EXCEEDED TErrorCode = 132
	TErrorCode_UNRESPONSIVE_BACKEND TErrorCode = 133
	TErrorCode_PARQUET_DATE_OUT_OF_RANGE TErrorCode = 134
	TErrorCode_DISCONNECTED_SESSION_CLOSED TErrorCode = 135
	TErrorCode_UNAUTHORIZED_SESSION_USER TErrorCode = 136
	TErrorCode_ZSTD_ERROR TErrorCode = 137
	TErrorCode_LZ4_BLOCK_DECOMPRESS_DECOMPRESS_SIZE_INCORRECT TErrorCode = 138
	TErrorCode_LZ4_BLOCK_DECOMPRESS_INVALID_INPUT_LENGTH TErrorCode = 139
	TErrorCode_LZ4_BLOCK_DECOMPRESS_INVALID_COMPRESSED_LENGTH TErrorCode = 140
	TErrorCode_LZ4_DECOMPRESS_SAFE_FAILED TErrorCode = 141
	TErrorCode_LZ4_COMPRESS_DEFAULT_FAILED TErrorCode = 142
	TErrorCode_MAX_STATEMENT_LENGTH_EXCEEDED TErrorCode = 143
	TErrorCode_AVRO_INVALID_DATE TErrorCode = 144
	TErrorCode_ORC_TIMESTAMP_OUT_OF_RANGE TErrorCode = 145
	TErrorCode_ORC_DATE_OUT_OF_RANGE TErrorCode = 146
	TErrorCode_ORC_NESTED_TYPE_MISMATCH TErrorCode = 147
	TErrorCode_ORC_TYPE_NOT_ROOT_AT_STRUCT TErrorCode = 148
	TErrorCode_NAAJ_OUT_OF_MEMORY TErrorCode = 149
	TErrorCode_INVALID_QUERY_HANDLE TErrorCode = 150
	TErrorCode_JOIN_ROWS_PRODUCED_LIMIT_EXCEEDED TErrorCode = 151
	TErrorCode_LOCAL_DISK_FAULTY TErrorCode = 152
	TErrorCode_JWKS_PARSE_ERROR TErrorCode = 153
	TErrorCode_JWT_VERIFY_FAILED TErrorCode = 154
	TErrorCode_PARQUET_ROWS_SKIPPING TErrorCode = 155
	TErrorCode_QUERY_OPTION_PARSE_FAILED TErrorCode = 156
	TErrorCode_CATALOG_INCOMPATIBLE_PROTOCOL TErrorCode = 157
	TErrorCode_STATESTORE_INCOMPATIBLE_PROTOCOL TErrorCode = 158
	TErrorCode_JDBC_CONFIGURATION_ERROR TErrorCode = 159
	TErrorCode_TUPLE_CACHE_INCONSISTENCY TErrorCode = 160
	TErrorCode_OAUTH_VERIFY_FAILED TErrorCode = 161
)

var knownTErrorCodeValues = []TErrorCode{
	TErrorCode_OK,
	TErrorCode_UNUSED,
	TErrorCode_GENERAL,
	TErrorCode_CANCELLED,
	TErrorCode_ANALYSIS_ERROR,
	TErrorCode_NOT_IMPLEMENTED_ERROR,
	TErrorCode_RUNTIME_ERROR,
	TErrorCode_MEM_LIMIT_EXCEEDED,
	TErrorCode_INTERNAL_ERROR,
	TErrorCode_RECOVERABLE_ERROR,
	TErrorCode_PARQUET_MULTIPLE_BLOCKS,
	TErrorCode_PARQUET_COLUMN_METADATA_INVALID,
	TErrorCode_PARQUET_HEADER_PAGE_SIZE_EXCEEDED,
	TErrorCode_PARQUET_HEADER_EOF,
	TErrorCode_PARQUET_GROUP_ROW_COUNT_ERROR,
	TErrorCode_PARQUET_GROUP_ROW_COUNT_OVERFLOW,
	TErrorCode_PARQUET_MISSING_PRECISION,
	TErrorCode_PARQUET_WRONG_PRECISION,
	TErrorCode_PARQUET_BAD_CONVERTED_TYPE,
	TErrorCode_PARQUET_INCOMPATIBLE_DECIMAL,
	TErrorCode_SEQUENCE_SCANNER_PARSE_ERROR,
	TErrorCode_SNAPPY_DECOMPRESS_INVALID_BLOCK_SIZE,
	TErrorCode_SNAPPY_DECOMPRESS_INVALID_COMPRESSED_LENGTH,
	TErrorCode_SNAPPY_DECOMPRESS_UNCOMPRESSED_LENGTH_FAILED,
	TErrorCode_SNAPPY_DECOMPRESS_RAW_UNCOMPRESS_FAILED,
	TErrorCode_SNAPPY_DECOMPRESS_DECOMPRESS_SIZE_INCORRECT,
	TErrorCode_FRAGMENT_EXECUTOR,
	TErrorCode_PARTITIONED_HASH_JOIN_MAX_PARTITION_DEPTH,
	TErrorCode_PARTITIONED_AGG_MAX_PARTITION_DEPTH,
	TErrorCode_MISSING_BUILTIN,
	TErrorCode_RPC_GENERAL_ERROR,
	TErrorCode_RPC_RECV_TIMEOUT,
	TErrorCode_UDF_VERIFY_FAILED,
	TErrorCode_PARQUET_CORRUPT_RLE_BYTES,
	TErrorCode_AVRO_DECIMAL_RESOLUTION_ERROR,
	TErrorCode_AVRO_DECIMAL_METADATA_MISMATCH,
	TErrorCode_AVRO_SCHEMA_RESOLUTION_ERROR,
	TErrorCode_AVRO_SCHEMA_METADATA_MISMATCH,
	TErrorCode_AVRO_UNSUPPORTED_DEFAULT_VALUE,
	TErrorCode_AVRO_MISSING_FIELD,
	TErrorCode_AVRO_MISSING_DEFAULT,
	TErrorCode_AVRO_NULLABILITY_MISMATCH,
	TErrorCode_AVRO_NOT_A_RECORD,
	TErrorCode_PARQUET_DEF_LEVEL_ERROR,
	TErrorCode_PARQUET_NUM_COL_VALS_ERROR,
	TErrorCode_PARQUET_DICT_DECODE_FAILURE,
	TErrorCode_SSL_PASSWORD_CMD_FAILED,
	TErrorCode_SSL_CERTIFICATE_PATH_BLANK,
	TErrorCode_SSL_PRIVATE_KEY_PATH_BLANK,
	TErrorCode_SSL_CERTIFICATE_NOT_FOUND,
	TErrorCode_SSL_PRIVATE_KEY_NOT_FOUND,
	TErrorCode_SSL_SOCKET_CREATION_FAILED,
	TErrorCode_MEM_ALLOC_FAILED,
	TErrorCode_PARQUET_REP_LEVEL_ERROR,
	TErrorCode_PARQUET_UNRECOGNIZED_SCHEMA,
	TErrorCode_COLLECTION_ALLOC_FAILED,
	TErrorCode_TMP_DEVICE_BLACKLISTED,
	TErrorCode_TMP_FILE_BLACKLISTED,
	TErrorCode_RPC_CLIENT_CONNECT_FAILURE,
	TErrorCode_STALE_METADATA_FILE_TOO_SHORT,
	TErrorCode_PARQUET_BAD_VERSION_NUMBER,
	TErrorCode_SCANNER_INCOMPLETE_READ,
	TErrorCode_SCANNER_INVALID_READ,
	TErrorCode_AVRO_BAD_VERSION_HEADER,
	TErrorCode_UDF_MEM_LIMIT_EXCEEDED,
	TErrorCode_UNUSED_65,
	TErrorCode_COMPRESSED_FILE_MULTIPLE_BLOCKS,
	TErrorCode_COMPRESSED_FILE_BLOCK_CORRUPTED,
	TErrorCode_COMPRESSED_FILE_DECOMPRESSOR_ERROR,
	TErrorCode_COMPRESSED_FILE_DECOMPRESSOR_NO_PROGRESS,
	TErrorCode_COMPRESSED_FILE_TRUNCATED,
	TErrorCode_DATASTREAM_SENDER_TIMEOUT,
	TErrorCode_KUDU_IMPALA_TYPE_MISSING,
	TErrorCode_IMPALA_KUDU_TYPE_MISSING,
	TErrorCode_KUDU_NOT_SUPPORTED_ON_OS,
	TErrorCode_KUDU_NOT_ENABLED,
	TErrorCode_PARTITIONED_HASH_JOIN_REPARTITION_FAILS,
	TErrorCode_UNUSED_77,
	TErrorCode_AVRO_TRUNCATED_BLOCK,
	TErrorCode_AVRO_INVALID_UNION,
	TErrorCode_AVRO_INVALID_BOOLEAN,
	TErrorCode_AVRO_INVALID_LENGTH,
	TErrorCode_SCANNER_INVALID_INT,
	TErrorCode_AVRO_INVALID_RECORD_COUNT,
	TErrorCode_AVRO_INVALID_COMPRESSED_SIZE,
	TErrorCode_AVRO_INVALID_METADATA_COUNT,
	TErrorCode_SCANNER_STRING_LENGTH_OVERFLOW,
	TErrorCode_PARQUET_CORRUPT_PLAIN_VALUE,
	TErrorCode_PARQUET_CORRUPT_DICTIONARY,
	TErrorCode_TEXT_PARSER_TRUNCATED_COLUMN,
	TErrorCode_SCRATCH_LIMIT_EXCEEDED,
	TErrorCode_BUFFER_ALLOCATION_FAILED,
	TErrorCode_PARQUET_ZERO_ROWS_IN_NON_EMPTY_FILE,
	TErrorCode_NO_REGISTERED_BACKENDS,
	TErrorCode_KUDU_KEY_ALREADY_PRESENT,
	TErrorCode_KUDU_NOT_FOUND,
	TErrorCode_KUDU_SESSION_ERROR,
	TErrorCode_AVRO_UNSUPPORTED_TYPE,
	TErrorCode_AVRO_INVALID_DECIMAL,
	TErrorCode_KUDU_NULL_CONSTRAINT_VIOLATION,
	TErrorCode_PARQUET_TIMESTAMP_OUT_OF_RANGE,
	TErrorCode_SCRATCH_ALLOCATION_FAILED,
	TErrorCode_SCRATCH_READ_TRUNCATED,
	TErrorCode_KUDU_TIMESTAMP_OUT_OF_RANGE,
	TErrorCode_MAX_ROW_SIZE,
	TErrorCode_IR_VERIFY_FAILED,
	TErrorCode_MINIMUM_RESERVATION_UNAVAILABLE,
	TErrorCode_ADMISSION_REJECTED,
	TErrorCode_ADMISSION_TIMED_OUT,
	TErrorCode_THREAD_CREATION_FAILED,
	TErrorCode_DISK_IO_ERROR,
	TErrorCode_DATASTREAM_RECVR_CLOSED,
	TErrorCode_BAD_PRINCIPAL_FORMAT,
	TErrorCode_LZ4_COMPRESSION_INPUT_TOO_LARGE,
	TErrorCode_SASL_APP_NAME_MISMATCH,
	TErrorCode_PARQUET_BIT_PACKED_LEVELS,
	TErrorCode_ROW_BATCH_TOO_LARGE,
	TErrorCode_LIB_VERSION_MISMATCH,
	TErrorCode_SCRATCH_READ_VERIFY_FAILED,
	TErrorCode_CANCELLED_INTERNALLY,
	TErrorCode_SERVER_SHUTTING_DOWN,
	TErrorCode_PARQUET_TIMESTAMP_INVALID_TIME_OF_DAY,
	TErrorCode_PARQUET_CORRUPT_BOOL_VALUE,
	TErrorCode_THREAD_POOL_SUBMIT_FAILED,
	TErrorCode_THREAD_POOL_TASK_TIMED_OUT,
	TErrorCode_UNREACHABLE_IMPALADS,
	TErrorCode_INACTIVE_SESSION_EXPIRED,
	TErrorCode_INACTIVE_QUERY_EXPIRED,
	TErrorCode_EXEC_TIME_LIMIT_EXCEEDED,
	TErrorCode_CPU_LIMIT_EXCEEDED,
	TErrorCode_SCAN_BYTES_LIMIT_EXCEEDED,
	TErrorCode_ROWS_PRODUCED_LIMIT_EXCEEDED,
	TErrorCode_EXPR_REWRITE_RESULT_LIMIT_EXCEEDED,
	TErrorCode_UNRESPONSIVE_BACKEND,
	TErrorCode_PARQUET_DATE_OUT_OF_RANGE,
	TErrorCode_DISCONNECTED_SESSION_CLOSED,
	TErrorCode_UNAUTHORIZED_SESSION_USER,
	TErrorCode_ZSTD_ERROR,
	TErrorCode_LZ4_BLOCK_DECOMPRESS_DECOMPRESS_SIZE_INCORRECT,
	TErrorCode_LZ4_BLOCK_DECOMPRESS_INVALID_INPUT_LENGTH,
	TErrorCode_LZ4_BLOCK_DECOMPRESS_INVALID_COMPRESSED_LENGTH,
	TErrorCode_LZ4_DECOMPRESS_SAFE_FAILED,
	TErrorCode_LZ4_COMPRESS_DEFAULT_FAILED,
	TErrorCode_MAX_STATEMENT_LENGTH_EXCEEDED,
	TErrorCode_AVRO_INVALID_DATE,
	TErrorCode_ORC_TIMESTAMP_OUT_OF_RANGE,
	TErrorCode_ORC_DATE_OUT_OF_RANGE,
	TErrorCode_ORC_NESTED_TYPE_MISMATCH,
	TErrorCode_ORC_TYPE_NOT_ROOT_AT_STRUCT,
	TErrorCode_NAAJ_OUT_OF_MEMORY,
	TErrorCode_INVALID_QUERY_HANDLE,
	TErrorCode_JOIN_ROWS_PRODUCED_LIMIT_EXCEEDED,
	TErrorCode_LOCAL_DISK_FAULTY,
	TErrorCode_JWKS_PARSE_ERROR,
	TErrorCode_JWT_VERIFY_FAILED,
	TErrorCode_PARQUET_ROWS_SKIPPING,
	TErrorCode_QUERY_OPTION_PARSE_FAILED,
	TErrorCode_CATALOG_INCOMPATIBLE_PROTOCOL,
	TErrorCode_STATESTORE_INCOMPATIBLE_PROTOCOL,
	TErrorCode_JDBC_CONFIGURATION_ERROR,
	TErrorCode_TUPLE_CACHE_INCONSISTENCY,
	TErrorCode_OAUTH_VERIFY_FAILED,
}

func TErrorCodeValues() iter.Seq[TErrorCode] {
	return func(yield func(TErrorCode) bool) {
		for _, v := range knownTErrorCodeValues {
			if !yield(v) {
				return
			}
		}
...
func (p TErrorCode) String() string {
	...
	case TErrorCode_PARQUET_BIT_PACKED_LEVELS: return "PARQUET_BIT_PACKED_LEVELS"
	case TErrorCode_ROW_BATCH_TOO_LARGE: return "ROW_BATCH_TOO_LARGE"
	case TErrorCode_LIB_VERSION_MISMATCH: return "LIB_VERSION_MISMATCH"
	case TErrorCode_SCRATCH_READ_VERIFY_FAILED: return "SCRATCH_READ_VERIFY_FAILED"
	case TErrorCode_CANCELLED_INTERNALLY: return "CANCELLED_INTERNALLY"
	case TErrorCode_SERVER_SHUTTING_DOWN: return "SERVER_SHUTTING_DOWN"
	case TErrorCode_PARQUET_TIMESTAMP_INVALID_TIME_OF_DAY: return "PARQUET_TIMESTAMP_INVALID_TIME_OF_DAY"
	case TErrorCode_PARQUET_CORRUPT_BOOL_VALUE: return "PARQUET_CORRUPT_BOOL_VALUE"
	case TErrorCode_THREAD_POOL_SUBMIT_FAILED: return "THREAD_POOL_SUBMIT_FAILED"
	case TErrorCode_THREAD_POOL_TASK_TIMED_OUT: return "THREAD_POOL_TASK_TIMED_OUT"
	case TErrorCode_UNREACHABLE_IMPALADS: return "UNREACHABLE_IMPALADS"
	case TErrorCode_INACTIVE_SESSION_EXPIRED: return "INACTIVE_SESSION_EXPIRED"
	case TErrorCode_INACTIVE_QUERY_EXPIRED: return "INACTIVE_QUERY_EXPIRED"
	case TErrorCode_EXEC_TIME_LIMIT_EXCEEDED: return "EXEC_TIME_LIMIT_EXCEEDED"
	case TErrorCode_CPU_LIMIT_EXCEEDED: return "CPU_LIMIT_EXCEEDED"
	case TErrorCode_SCAN_BYTES_LIMIT_EXCEEDED: return "SCAN_BYTES_LIMIT_EXCEEDED"
	case TErrorCode_ROWS_PRODUCED_LIMIT_EXCEEDED: return "ROWS_PRODUCED_LIMIT_EXCEEDED"
	case TErrorCode_EXPR_REWRITE_RESULT_LIMIT_EXCEEDED: return "EXPR_REWRITE_RESULT_LIMIT_EXCEEDED"
	case TErrorCode_UNRESPONSIVE_BACKEND: return "UNRESPONSIVE_BACKEND"
	case TErrorCode_PARQUET_DATE_OUT_OF_RANGE: return "PARQUET_DATE_OUT_OF_RANGE"
	case TErrorCode_DISCONNECTED_SESSION_CLOSED: return "DISCONNECTED_SESSION_CLOSED"
	case TErrorCode_UNAUTHORIZED_SESSION_USER: return "UNAUTHORIZED_SESSION_USER"
	case TErrorCode_ZSTD_ERROR: return "ZSTD_ERROR"
	case TErrorCode_LZ4_BLOCK_DECOMPRESS_DECOMPRESS_SIZE_INCORRECT: return "LZ4_BLOCK_DECOMPRESS_DECOMPRESS_SIZE_INCORRECT"
	case TErrorCode_LZ4_BLOCK_DECOMPRESS_INVALID_INPUT_LENGTH: return "LZ4_BLOCK_DECOMPRESS_INVALID_INPUT_LENGTH"
	case TErrorCode_LZ4_BLOCK_DECOMPRESS_INVALID_COMPRESSED_LENGTH: return "LZ4_BLOCK_DECOMPRESS_INVALID_COMPRESSED_LENGTH"
	case TErrorCode_LZ4_DECOMPRESS_SAFE_FAILED: return "LZ4_DECOMPRESS_SAFE_FAILED"
	case TErrorCode_LZ4_COMPRESS_DEFAULT_FAILED: return "LZ4_COMPRESS_DEFAULT_FAILED"
	case TErrorCode_MAX_STATEMENT_LENGTH_EXCEEDED: return "MAX_STATEMENT_LENGTH_EXCEEDED"
	case TErrorCode_AVRO_INVALID_DATE: return "AVRO_INVALID_DATE"
	case TErrorCode_ORC_TIMESTAMP_OUT_OF_RANGE: return "ORC_TIMESTAMP_OUT_OF_RANGE"
	case TErrorCode_ORC_DATE_OUT_OF_RANGE: return "ORC_DATE_OUT_OF_RANGE"
	case TErrorCode_ORC_NESTED_TYPE_MISMATCH: return "ORC_NESTED_TYPE_MISMATCH"
	case TErrorCode_ORC_TYPE_NOT_ROOT_AT_STRUCT: return "ORC_TYPE_NOT_ROOT_AT_STRUCT"
	case TErrorCode_NAAJ_OUT_OF_MEMORY: return "NAAJ_OUT_OF_MEMORY"
	case TErrorCode_INVALID_QUERY_HANDLE: return "INVALID_QUERY_HANDLE"
	case TErrorCode_JOIN_ROWS_PRODUCED_LIMIT_EXCEEDED: return "JOIN_ROWS_PRODUCED_LIMIT_EXCEEDED"
	case TErrorCode_LOCAL_DISK_FAULTY: return "LOCAL_DISK_FAULTY"
	case TErrorCode_JWKS_PARSE_ERROR: return "JWKS_PARSE_ERROR"
	case TErrorCode_JWT_VERIFY_FAILED: return "JWT_VERIFY_FAILED"
	case TErrorCode_PARQUET_ROWS_SKIPPING: return "PARQUET_ROWS_SKIPPING"
	case TErrorCode_QUERY_OPTION_PARSE_FAILED: return "QUERY_OPTION_PARSE_FAILED"
	case TErrorCode_CATALOG_INCOMPATIBLE_PROTOCOL: return "CATALOG_INCOMPATIBLE_PROTOCOL"
	case TErrorCode_STATESTORE_INCOMPATIBLE_PROTOCOL: return "STATESTORE_INCOMPATIBLE_PROTOCOL"
	case TErrorCode_JDBC_CONFIGURATION_ERROR: return "JDBC_CONFIGURATION_ERROR"
	case TErrorCode_TUPLE_CACHE_INCONSISTENCY: return "TUPLE_CACHE_INCONSISTENCY"
	case TErrorCode_OAUTH_VERIFY_FAILED: return "OAUTH_VERIFY_FAILED"
	}
	return "<UNSET>"
}
...
func TErrorCodeFromString(s string) (TErrorCode, error) {
	...
	case "PARQUET_BIT_PACKED_LEVELS": return TErrorCode_PARQUET_BIT_PACKED_LEVELS, nil
	case "ROW_BATCH_TOO_LARGE": return TErrorCode_ROW_BATCH_TOO_LARGE, nil
	case "LIB_VERSION_MISMATCH": return TErrorCode_LIB_VERSION_MISMATCH, nil
	case "SCRATCH_READ_VERIFY_FAILED": return TErrorCode_SCRATCH_READ_VERIFY_FAILED, nil
	case "CANCELLED_INTERNALLY": return TErrorCode_CANCELLED_INTERNALLY, nil
	case "SERVER_SHUTTING_DOWN": return TErrorCode_SERVER_SHUTTING_DOWN, nil
	case "PARQUET_TIMESTAMP_INVALID_TIME_OF_DAY": return TErrorCode_PARQUET_TIMESTAMP_INVALID_TIME_OF_DAY, nil
	case "PARQUET_CORRUPT_BOOL_VALUE": return TErrorCode_PARQUET_CORRUPT_BOOL_VALUE, nil
	case "THREAD_POOL_SUBMIT_FAILED": return TErrorCode_THREAD_POOL_SUBMIT_FAILED, nil
	case "THREAD_POOL_TASK_TIMED_OUT": return TErrorCode_THREAD_POOL_TASK_TIMED_OUT, nil
	case "UNREACHABLE_IMPALADS": return TErrorCode_UNREACHABLE_IMPALADS, nil
	case "INACTIVE_SESSION_EXPIRED": return TErrorCode_INACTIVE_SESSION_EXPIRED, nil
	case "INACTIVE_QUERY_EXPIRED": return TErrorCode_INACTIVE_QUERY_EXPIRED, nil
	case "EXEC_TIME_LIMIT_EXCEEDED": return TErrorCode_EXEC_TIME_LIMIT_EXCEEDED, nil
	case "CPU_LIMIT_EXCEEDED": return TErrorCode_CPU_LIMIT_EXCEEDED, nil
	case "SCAN_BYTES_LIMIT_EXCEEDED": return TErrorCode_SCAN_BYTES_LIMIT_EXCEEDED, nil
	case "ROWS_PRODUCED_LIMIT_EXCEEDED": return TErrorCode_ROWS_PRODUCED_LIMIT_EXCEEDED, nil
	case "EXPR_REWRITE_RESULT_LIMIT_EXCEEDED": return TErrorCode_EXPR_REWRITE_RESULT_LIMIT_EXCEEDED, nil
	case "UNRESPONSIVE_BACKEND": return TErrorCode_UNRESPONSIVE_BACKEND, nil
	case "PARQUET_DATE_OUT_OF_RANGE": return TErrorCode_PARQUET_DATE_OUT_OF_RANGE, nil
	case "DISCONNECTED_SESSION_CLOSED": return TErrorCode_DISCONNECTED_SESSION_CLOSED, nil
	case "UNAUTHORIZED_SESSION_USER": return TErrorCode_UNAUTHORIZED_SESSION_USER, nil
	case "ZSTD_ERROR": return TErrorCode_ZSTD_ERROR, nil
	case "LZ4_BLOCK_DECOMPRESS_DECOMPRESS_SIZE_INCORRECT": return TErrorCode_LZ4_BLOCK_DECOMPRESS_DECOMPRESS_SIZE_INCORRECT, nil
	case "LZ4_BLOCK_DECOMPRESS_INVALID_INPUT_LENGTH": return TErrorCode_LZ4_BLOCK_DECOMPRESS_INVALID_INPUT_LENGTH, nil
	case "LZ4_BLOCK_DECOMPRESS_INVALID_COMPRESSED_LENGTH": return TErrorCode_LZ4_BLOCK_DECOMPRESS_INVALID_COMPRESSED_LENGTH, nil
	case "LZ4_DECOMPRESS_SAFE_FAILED": return TErrorCode_LZ4_DECOMPRESS_SAFE_FAILED, nil
	case "LZ4_COMPRESS_DEFAULT_FAILED": return TErrorCode_LZ4_COMPRESS_DEFAULT_FAILED, nil
	case "MAX_STATEMENT_LENGTH_EXCEEDED": return TErrorCode_MAX_STATEMENT_LENGTH_EXCEEDED, nil
	case "AVRO_INVALID_DATE": return TErrorCode_AVRO_INVALID_DATE, nil
	case "ORC_TIMESTAMP_OUT_OF_RANGE": return TErrorCode_ORC_TIMESTAMP_OUT_OF_RANGE, nil
	case "ORC_DATE_OUT_OF_RANGE": return TErrorCode_ORC_DATE_OUT_OF_RANGE, nil
	case "ORC_NESTED_TYPE_MISMATCH": return TErrorCode_ORC_NESTED_TYPE_MISMATCH, nil
	case "ORC_TYPE_NOT_ROOT_AT_STRUCT": return TErrorCode_ORC_TYPE_NOT_ROOT_AT_STRUCT, nil
	case "NAAJ_OUT_OF_MEMORY": return TErrorCode_NAAJ_OUT_OF_MEMORY, nil
	case "INVALID_QUERY_HANDLE": return TErrorCode_INVALID_QUERY_HANDLE, nil
	case "JOIN_ROWS_PRODUCED_LIMIT_EXCEEDED": return TErrorCode_JOIN_ROWS_PRODUCED_LIMIT_EXCEEDED, nil
	case "LOCAL_DISK_FAULTY": return TErrorCode_LOCAL_DISK_FAULTY, nil
	case "JWKS_PARSE_ERROR": return TErrorCode_JWKS_PARSE_ERROR, nil
	case "JWT_VERIFY_FAILED": return TErrorCode_JWT_VERIFY_FAILED, nil
	case "PARQUET_ROWS_SKIPPING": return TErrorCode_PARQUET_ROWS_SKIPPING, nil
	case "QUERY_OPTION_PARSE_FAILED": return TErrorCode_QUERY_OPTION_PARSE_FAILED, nil
	case "CATALOG_INCOMPATIBLE_PROTOCOL": return TErrorCode_CATALOG_INCOMPATIBLE_PROTOCOL, nil
	case "STATESTORE_INCOMPATIBLE_PROTOCOL": return TErrorCode_STATESTORE_INCOMPATIBLE_PROTOCOL, nil
	case "JDBC_CONFIGURATION_ERROR": return TErrorCode_JDBC_CONFIGURATION_ERROR, nil
	case "TUPLE_CACHE_INCONSISTENCY": return TErrorCode_TUPLE_CACHE_INCONSISTENCY, nil
	case "OAUTH_VERIFY_FAILED": return TErrorCode_OAUTH_VERIFY_FAILED, nil
	}
